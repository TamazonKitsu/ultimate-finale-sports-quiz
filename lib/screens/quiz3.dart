...
class VolleyballQuiz {
  static final originalQuestions = [
    {"question": "วอลเลย์บอลมีผู้เล่นกี่คนในสนาม", "choices": ["4 คน", "6 คน", "8 คน", "10 คน"], "correctAnswer": "6 คน"},
    ...
    {"question": "เส้นแบ่งเขตแดนในสนามวอลเลย์บอลมีความสูงเท่าไหร่", "choices": ["1 เมตร", "1.5 เมตร", "2 เมตร", "2.5 เมตร"], "correctAnswer": "2 เมตร"},
    ...
    {"question": "อะไรคือจุดประสงค์หลักของการบล็อกในวอลเลย์บอล", "choices": ["ส่งลูกให้เพื่อนร่วมทีม", "ป้องกันไม่ให้ลูกวอลเลย์บอลข้ามตาข่าย", "ทำคะแนน", "ทั้งหมดข้างต้น"], "correctAnswer": "ป้องกันไม่ให้ลูกวอลเลย์บอลข้ามตาข่าย"},
    {"question": "ผู้เล่นสามารถสัมผัสลูกวอลเลย์บอลได้กี่ครั้งติดต่อกันภายในหนึ่งแรลลี่", "choices": ["1 ครั้ง", "2 ครั้ง", "3 ครั้ง", "4 ครั้ง"], "correctAnswer": "2 ครั้ง"},
    ...
    {"question": "อะไรคือท่าที่ใช้ในการรับลูกตบ", "choices": ["ท่าตบ", "ท่ารับ", "ท่าเสิร์ฟ", "ท่าบล็อก"], "correctAnswer": "ท่ารับ"},
    {"question": "ผู้เล่นสามารถหมุนเปลี่ยนตัวได้กี่ครั้ง", "choices": ["6 ครั้ง", "12 ครั้ง", "18 ครั้ง", "ไม่มีจำกัด"], "correctAnswer": "12 ครั้ง"},
    {"question": "อะไรคือคะแนนพิเศษในวอลเลย์บอล", "choices": ["เอซ", "บล็อก", "เซ็ต", "ทั้งหมดข้างต้น"], "correctAnswer": "ทั้งหมดข้างต้น"},
    ...
    {"question": "อะไรคือชื่อทีมวอลเลย์บอลหญิงทีมชาติไทย", "choices": ["วอลเลย์บอลสาวไทย", "วอลเลย์บอลไทย", "วอลเลย์บอลทีมชาติไทย", "วอลเลย์บอลดาราไทย"], "correctAnswer": "วอลเลย์บอลสาวไทย"},
